...
import {APP_VERSION_LABEL,APP_TITLE} from '../core-version-01/version-info.js?v=1.7.10';
...
import {createRealisticDeviceModel} from './device-model-factory.js?v=1.7.10';
import {connectionsTriggeredBy,actionForTargetTerminal,noteSignal} from '../core-logic-01/connection-runtime.js?v=1.7.10';
...
const controllerApi={
    ...
    resetCar(){car.position.set(-2.05,0,15);car.rotation.y=0;exitCar.position.set(2.05,0,-15);exitCar.rotation.y=Math.PI;exitCar.visible=false;speed=0;keys.clear();showToast('車輛已重設');},
