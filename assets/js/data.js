export const categories = [
  {id:'overview',label:'整體總覽'}, {id:'simulator',label:'3D編輯/模擬'}, {id:'scene',label:'場景/視野'},
  {id:'layers',label:'樓層/群組'}, {id:'hotkeys',label:'快捷鍵'}, {id:'display',label:'多螢幕'}, {id:'mission',label:'任務'},
...
export const featureGroups = [
  ...
  ['3D編輯','設備點選、拖移、旋轉、樓層切換、屬性面板、視角記錄'],
